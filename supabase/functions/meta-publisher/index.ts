  ...
  try{
    if(req.method==="GET"&&url.searchParams.get("mode")==="callback"){
      ...
      if(candidates.length>1){
        ...
        return html(`Pronađeno je ${candidates.length} Facebook stranica. Vrati se u Restorapp i izaberi stranicu za ovaj restoran.`);
      }
