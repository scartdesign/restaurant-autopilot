alter table public.restaurants
  add column if not exists trend_weekly_digest_enabled boolean not null default true;
...
begin
  ...
  inserted as (
    ...
    select
      ...
      null,
      'trend_weekly_digest',
      'Trend Weekly Brief · '||opportunity_count||case when opportunity_count=1 then ' prilika' else ' prilike' end,
