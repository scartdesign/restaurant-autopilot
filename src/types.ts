...
export type NotificationOutbox = {
  ...
  kind: 'order_created' | 'order_paid' | 'trial_started' | 'license_activated' | 'subscription_expiring' | 'subscription_expired' | 'admin_note' | 'support_created' | 'performance_reminder' | 'weekly_plan_ready' | 'trend_opportunity'
  subject: string
  body: string
